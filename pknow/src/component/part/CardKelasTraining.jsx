      ...
      <div className="bg-white-kk">
        ...
        <div className="row">
            <div className="d-flex justify-content-between align-items-center mt-4">
              <h3 className="text-xl font-bold text-blue-600" style={{ fontSize: "17px" }}>
                {decode(data.title)}
              </h3>
            </div>
        </div>
        ...
        <div className="pemilik ">
            <div className="prodi" style={{fontSize:"14px", color:"#4D4D4D"}}>
              <FontAwesomeIcon icon={faGraduationCap} className="icon-style" style={{fontSize:"20px"}} />
              <p className="700" style={{ marginLeft: "15px", width:"100%", fontSize:"14px", color:"#4D4D4D" }}>
                {data.ProgramStudi}
              </p>
            </div>
        </div>
        <div className="pemilik ">
            <div className="prodi" style={{fontSize:"14px", color:"#4D4D4D"}}>
            <i className="fas fa-tag" style={{fontSize:"20px", paddingLeft:"5px"}}></i>
              <p className="700 ml-3" style={{ marginLeft: "15px", width:"100%", fontSize:"14px", color:"#4D4D4D" }}>
